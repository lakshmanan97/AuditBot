...
const filterreducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case actionType.CHANGE_RISKTYPE_FILTER:
      return {
        ...state,
        riskType: { ...state.riskType, selectedValue: action.value },
      };
    case actionType.CHANGE_RISKLEVEL_FILTER:
      return {
        ...state,
        riskLevel: { ...state.riskLevel, selectedValue: action.value },
      };
    case actionType.CHANGE_CLIENT_FILTER:
      return {
        ...state,
        client: { ...state.client, selectedValue: action.value },
      };
    ...
    case actionType.CHANGE_MITIGATION_FILTER:
      return {
        ...state,
        mitigation: { ...state.mitigation, selectedValue: action.value },
      };
    case actionType.CHANGE_RISK_ID:
      return {
        ...state,
        riskid: { ...state.riskid, selectedValue: action.value },
      };
    case actionType.CHANGE_REPORT_TYPE:
      return {
        ...state,
        reportType: { ...state.reportType, selectedValue: action.value },
      };
    case actionType.CHANGE_REPORTVIEW_TYPE:
      return {
        ...state,
        reportView: { ...state.reportView, selectedValue: action.value },
      };
    case actionType.CHANGE_DRILL_DOWN:
      return {
        ...state,
        drillDown: { ...state.drillDown, selectedValue: action.value },
      };
    ...
    case actionType.UPDATE_RESULT:
      return {
        ...
        tableReportShow: false,
        loader: false,
        levelSelected: state.level.selectedValue,
        reportTypeSelected: state.reportType.selectedValue,
        sapSystem: {
          ...state.sapSystem,
          filtered: state.sapSystem.selectedValue,
        },
        client: { ...state.client, filtered: state.client.selectedValue },
        riskType: { ...state.riskType, filtered: state.riskType.selectedValue },
        riskLevel: {
          ...state.riskLevel,
          filtered: state.riskLevel.selectedValue,
        },
        businessModule: {
          ...state.businessModule,
          filtered: state.businessModule.selectedValue,
        },
        mitigation: {
          ...state.mitigation,
          filtered: state.mitigation.selectedValue,
        },
        drillDown: {
          ...state.drillDown,
          filtered: state.drillDown.selectedValue,
        },
        level: { ...state.level, filtered: state.level.selectedValue },
        reportType: {
          ...state.reportType,
          filtered: state.reportType.selectedValue,
        },
    ...
    case actionType.CLEAR_RESULT:
      return {
        ...state,
        result: null,
        businessModule: { ...state.businessModule, selectedValue: [] },
        riskType: { ...state.riskType, selectedValue: [] },
    ...
    case actionType.CLEAR_GRCREPORT:
      return { ...state, tableRiskTechReport: action.tableRiskTechReport };
  }
