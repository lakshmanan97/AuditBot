...
class GRCReportCompanyCode extends Component {
        ...
        return (
            <Grid container style={{ marginTop: 5, paddingRight: 10, paddingLeft: 10 }} spacing={0}>
                <Grid item md={12} style={{ margin: 5 }}>
                    {this.props.sapSystem.value.length > 0 ? <GRCCompanyFilter type='Report' /> : null}
...
export default connect(mapStateToProps, mapDispatchToProps)(GRCReportCompanyCode);//connect which return a HOC taking two parameters which help connect to redux store and component