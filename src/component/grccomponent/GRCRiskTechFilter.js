  ...
  changeRiskType = (value) => {
    if (value.includes("G")) {
      this.props.onChangeFilter(
        ...
        this.props.reportView.value[1].ZID
      );
    }
  ...
  render() {
    ...
    let drillDown =
      Object.keys(this.props.drillDown).length != 0
        ...
        : [];
    let reportView =
      Object.keys(this.props.reportView).length != 0
      ...
      <Card elevation="5">
        ...
        >
          ...
          >
            ...
            <Grid
              item
              md={this.props.type == "Dashbord" ? 2 : 2}
              style={{ marginTop: "auto", marginBottom: "auto" }}
            >
              <FilterMultiSelectDropDown
                values={riskid}
            ...
            >
              <FilterSingleSelectDropDown
                values={reportView}
                preSelected={this.props.reportView.selectedValue}
                changeEventCallBack={this.changeReportViewType}
                label={this.props.reportView.name}
                width="100"
              />
            </Grid>
            <Grid
